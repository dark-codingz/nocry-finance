...
// - `closingDay` e `dueDay`: Usam `coerce.number()` para converter a string do input
//   para número. A validação `.min(1).max(31)` garante que sejam dias válidos do mês.
    ...
    <form onSubmit={handleSubmit(onNext)} className="space-y-6">
      ...
      <div className="flex gap-4">
        <div className="flex-1">
          ...
          <input id="card_closing" type="number" {...register('closingDay')} placeholder="Ex: 25" className="mt-1 block w-full p-2 border border-gray-300 rounded-md" />
        ...
        <div className="flex-1">
          ...
          <input id="card_due" type="number" {...register('dueDay')} placeholder="Ex: 05" className="mt-1 block w-full p-2 border border-gray-300 rounded-md" />

...
// ============================================================================
// Propósito: Autenticar usuários usando email e senha com identidade visual
// da NoCry Group (fundo preto, dourado, minimalista).
// 
// DESIGN SYSTEM (NoCry Group):
// - Fundo: #000000 (preto absoluto)
// - Dourado: #D4AF37 (logo, borda, botão)
// - Texto: #CACACA (labels, descrições)
// - Card: #161616 (background do card de login)
// 
// FLUXO DE AUTENTICAÇÃO:
// 1. Usuário insere email e senha
// 2. Validação client-side (email válido, senha >= 5 caracteres)
// 3. Submit aciona `supabase.auth.signInWithPassword({ email, password })`
// 4. Sucesso: redireciona para ?next= ou /
// 5. Erro: exibe mensagem de erro amigável
// 
// UX/ACESSIBILIDADE:
// - Labels conectados por htmlFor/id
// - aria-invalid quando houver erro
// - Focus visível com ring dourado
// - "Esqueceu sua senha?": abre alert informando para contatar desenvolvedor
// ============================================================================
...
function LoginContent() {
  ...
  // Se já estiver logado, mostra loading enquanto redireciona
  if (session) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-[#000000]">
        <div className="text-center">
          ...
          <p className="mt-4 text-[#CACACA] text-sm">Redirecionando...</p>
        </div>
      </main>
    );
  }
